...
return [
    ...
    'attributes'             => [
        ...
        'exam_type_id'                        => 'Tipe Ujian',
        'question_unit_id'                    => 'Unit Soal',
        'question_sub_unit_id'                => 'Sub Unit Soal',
        'selection_stage_type_id'             => 'Tipe Tahapan Seleksi',
        'passing_grade'                       => 'Nilai Ambang Batas',
        'duration_minutes'                    => 'Durasi Pengerjaan',
        'start_time'                          => 'Waktu Mulai',
        'end_time'                            => 'Waktu Selesai',
        'is_active'                           => 'Status Ketersediaan',
        'is_passing'                          => 'Status Kelulusan NAB',
        'min_score'                           => 'Skor Minimal',
        'max_score'                           => 'Skor Maks',
        'sort_order'                          => 'Urutan',
        'evaluation_method'                   => 'Metode Evaluasi',
        'nip'                                 => 'NIP',
        'unit_name'                           => 'Nama Unit',
        'cbt_weight'                          => 'Bobot CBT',
        'technical_scoring_config.cbt_weight' => 'Bobot CBT',
        'technical_scoring_config.stages'     => 'Tahap Seleksi',
    ],
];
