<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-1 mt-1">
    ...
    <div wire:click="mountAction('viewNoActivity')" 
        ...
        <div class="flex items-start justify-between">
            <div class="flex-1">
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Sedang Berlangsung Tanpa Aktivitas</p>
                <div class="mt-2 flex items-baseline gap-2">
                    <span class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">{{ $examsOngoingNoActivity }}</span>
                    <span class="text-xs text-gray-400">ujian bermasalah</span>
                </div>
            </div>
            <div class="relative p-2 bg-warning-50 dark:bg-warning-500/10 rounded-lg text-warning-600 dark:text-warning-400 group-hover:bg-warning-600 group-hover:text-white transition-colors">
        ...
        {{-- Decorative stripe --}}
        <div class="absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r from-warning-400 to-warning-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300"></div>
    </div>
    @endif
    ...
    <div wire:click="mountAction('viewStartingSoon')" 
        ...
        <div class="flex items-start justify-between">
            <div class="flex-1">
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Segera Mulai In < 1h</p>
                <div class="mt-2 flex items-baseline gap-2">
                    <span class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">{{ $examsStartingSoon }}</span>
                    <span class="text-xs text-gray-400">ujian</span>
                </div>
            </div>
            <div class="p-2 bg-info-50 dark:bg-info-500/10 rounded-lg text-info-600 dark:text-info-400 group-hover:bg-info-600 group-hover:text-white transition-colors">
                <x-heroicon-o-clock class="w-6 h-6" />
            </div>
        </div>
        
        <div class="absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r from-info-400 to-info-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300"></div>
    </div>
    @endif
    ...
    <div wire:click="mountAction('viewLoggedOut')" 
        ...
        <div class="flex items-start justify-between">
            <div class="flex-1">
                ...
                <div class="mt-2 flex items-baseline gap-2">
                    <span class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">{{ $participantsLoggedOut }}</span>
                    <span class="text-xs text-gray-400">peserta</span>
                </div>
            </div>
            <div class="p-2 bg-danger-50 dark:bg-danger-500/10 rounded-lg text-danger-600 dark:text-danger-400 group-hover:bg-danger-600 group-hover:text-white transition-colors">
                <x-heroicon-o-user-minus class="w-6 h-6" />
            </div>
        </div>
        
        <div class="absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r from-danger-400 to-danger-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300"></div>
    </div>
    @endif
</div>
