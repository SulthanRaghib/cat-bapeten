<div wire:poll.3s x-data="{ confirmForceFinish: false }">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div class="col-span-1 space-y-4">
            ...
            <div class="flex flex-col gap-2">
                <x-filament::button color="danger" icon="heroicon-m-stop" @click="confirmForceFinish = true">
                    Paksa Selesai
                </x-filament::button>
            </div>
        </div>
        ...
        <div x-show="confirmForceFinish" style="display: none;" class="fixed inset-0 z-50 overflow-y-auto"
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <div x-show="confirmForceFinish" x-transition:enter="ease-out duration-300"
                    ...
                    @click="confirmForceFinish = false"></div>
                ...
                <div x-show="confirmForceFinish" x-transition:enter="ease-out duration-300"
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse gap-2">
                        <x-filament::button color="danger" icon="heroicon-m-stop"
                            wire:click="todoForceFinish({{ $record->id }})" @click="confirmForceFinish = false">
                            Ya, Akhiri Ujian
                        </x-filament::button>
                        <x-filament::button color="gray" @click="confirmForceFinish = false">
                            Batal
                        </x-filament::button>
                    </div>
                </div>
